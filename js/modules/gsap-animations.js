...
/* ─── SVG Line Drawing Animation (Disabled for smooth scroll performance) ─ */
function svgDrawAnimation() {
  // Disabled: getTotalLength() queries across hundreds of SVGs trigger forced reflows & scroll jank
}
